  ...
  >
    <ProLayout
      ...
      menuItemRender={(itemProps, defaultDom, props) => {
        ...
        return <Link to={itemProps.path} onMouseEnter={e => e.preventDefault()}>>{itemProps.icon && itemProps.icon}{itemProps.name}</Link>
      }}
      subMenuItemRender={(itemProps) => {
       
        return <div onMouseEnter={e => e.preventDefault()}>{itemProps.icon && itemProps.icon}{itemProps.name}</div>
      }}
